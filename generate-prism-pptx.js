...
function addFlares(slide) {
  // Corner colour ovals — each standalone, no blending
  slide.addShape(pptx.shapes.OVAL, {
    x: -3.5, y: -3.5, w: 9, h: 9,
    fill: { color: SKY, transparency: 72 }, line: { width: 0 },
  });
  slide.addShape(pptx.shapes.OVAL, {
    x: 7.5, y: -3.5, w: 9, h: 9,
    fill: { color: ROSE, transparency: 74 }, line: { width: 0 },
  });
  slide.addShape(pptx.shapes.OVAL, {
    x: 7.5, y: 2.5, w: 9, h: 9,
    fill: { color: AMBER, transparency: 76 }, line: { width: 0 },
  });
  slide.addShape(pptx.shapes.OVAL, {
    x: -3.5, y: 2.5, w: 9, h: 9,
    fill: { color: MINT, transparency: 72 }, line: { width: 0 },
  });
  // White light-flash hotspots inside each corner
  slide.addShape(pptx.shapes.OVAL, {
    x: 0.5, y: 0.5, w: 2.2, h: 2.2,
    fill: { color: "FFFFFF", transparency: 55 }, line: { width: 0 },
  });
  slide.addShape(pptx.shapes.OVAL, {
    x: 10.5, y: 0.8, w: 2, h: 2,
    fill: { color: "FFFFFF", transparency: 60 }, line: { width: 0 },
  });
  slide.addShape(pptx.shapes.OVAL, {
    x: 10, y: 4.8, w: 2.2, h: 2.2,
    fill: { color: "FFFFFF", transparency: 58 }, line: { width: 0 },
  });
  slide.addShape(pptx.shapes.OVAL, {
    x: 0.8, y: 4.8, w: 2, h: 2,
    fill: { color: "FFFFFF", transparency: 60 }, line: { width: 0 },
...
// GENERATE
// ═══════════════════════════════════════
const outPath = "/Users/jvanwaveren/IFC/IFC_PitchDeck_Prism.pptx";
