// Generate IFC Business Plan 2026 — Prism-style PPTX (clean variant, no corner flares)
// Output: /Users/jvanwaveren/IFC/IFC_BusinessPlan_2026_clean.pptx
//
// Identical to the atmospheric generator, but with the four colored corner flare
// ovals (and their white hotspots) suppressed — leaving a clean deep-mint
// background with glass panels, drop shadows, accent bars, spectrum lines and
// colored typography. More minimal / corporate feel while keeping the glass.
...
function addFlares(_slide) {
  // Clean variant: no corner flare ovals. Background stays the flat DEEP mint
  // set by the PRISM slide master. All other Prism elements (glass panels,
  // accent bars, spectrum lines, colored text) are retained.
}
...
// ── Write out ───────────────────────────────────────────────
const outPath = "/Users/jvanwaveren/IFC/IFC_BusinessPlan_2026_clean.pptx";
